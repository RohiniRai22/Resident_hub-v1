...
export default function ManageSubService() {
  ...
  useEffect(() => {
    axios
      .get(`${host}/api/admin/get-sub-service`)
      .then((res) => {
      ...
      .catch((err) => {
        console.error("Error fetching sub-services:", err.message);
        toast.error("Failed to load sub-services. Please try again later.");
      });
  }, [delService]);
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      title: "Are you sure?",
      text: "You want to delete this sub-service",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${host}/api/admin/delete-sub-service/${id}`)
          .then((response) => {
  ...
  const handleUpdateService = () => {
    axios
      .put(
        `${host}/api/admin/update-sub-service/${editService._id}`,
        editService
      )
      .then((res) => {
        setDelService(!delService);
