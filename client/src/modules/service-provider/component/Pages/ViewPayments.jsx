...
//                         {row.orderId?._id || "N/A"} {/* Check if orderId is populated */}
//                       </StyledTableCell>
//                       <StyledTableCell align="center">
//                         {row.transactionId || "N/A"} {/* Handle cases where transactionId may not exist */}
//                       </StyledTableCell>
//                       <StyledTableCell align="center">
//                         {row.paymentStatus || "Unknown"} {/* Handle missing status */}
//                       </StyledTableCell>
//                       <StyledTableCell align="center">
...
export default function ViewPayments() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5000/api/payment/getPaymentsByServiceProvider/${serviceProviderId}`)
      .then((res) => {
